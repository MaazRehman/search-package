...
const PackageInfoContext = createContext<PackageDataContext | undefined>(undefined);

interface PackageInfoProviderProps {
    children: ReactNode;
}

export const PackageInfoProvider: React.FC<PackageInfoProviderProps> = ({ children }) => {
